...
class Session {
    ...
    send({ id, params }) {
        this.require(Service.json(id, params, this._userId, this._password));
    }
    ...
    login() {
        this.require(Service.json('loadCurrentUser'));
        ...
        this.require(Service.json('syslogin', {
